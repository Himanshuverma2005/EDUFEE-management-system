...
export default function EmailTestComponent() {
  ...
  const testPasswordReset = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setResult('Password reset email sent successfully! Check your inbox (and spam folder).');
      }
    } catch (error) {
      console.error('Password reset test error:', error);
      setResult(`Error: ${error instanceof Error ? error.message : 'Unknown error'}`);
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-bold mb-4">Email Test Tool</h2>
      ...
      <div className="mt-4 text-sm text-gray-600">
        ...
        <ul className="list-disc list-inside space-y-1 mt-2">
          ...
          <li>Click either test button</li>
